...
g++ -std=c++17 -Iinclude -Isrc tests/error_tests.cpp src/interpreter/interpreter.cpp src/lexer/lexer.cpp src/parser/parser.cpp src/ast/nodes.cpp src/utils/string_utils.cpp -o /tmp/magphos_tests/error_tests
